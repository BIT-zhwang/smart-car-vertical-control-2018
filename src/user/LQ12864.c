...
//--------这里修改定义端口------//  
#define LCD_SCL  PTD6_OUT
#define LCD_SDA  PTE5_OUT
#define LCD_RST  PTB5_OUT
#define LCD_DC   PTE6_OUT
#define LCD_CS   PTH0_OUT
...
{ 
  //-----端口初始化----//
  gpio_init (PTD6, GPO,HIGH);
  gpio_init (PTE5, GPO,HIGH);
  gpio_init (PTB5, GPO,HIGH);
